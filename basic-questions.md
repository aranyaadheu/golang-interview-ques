...
<h2 id="what-is-block">২। What is block?</h2>
...
<h2 id="how-many-types-of-scopes-are-there-available-on-golang">৩। How many types of scopes are there available on Golang?</h2>
...
<h2 id="what-is-the-standard-or-named-function">৪। What is the standard or named function?</h2>
...
<h2 id="what-is-expression">৬। What is expression?</h2>
...
<h2 id="what-is-function-expression">৭। What is function expression?</h2>
...
<h2 id="what-is-immediately-invoked-function-expression-iife">৮। What is immediately invoked function expression (IIFE)?</h2>
...
<h2 id="difference-between-arguments-and-parameters">৯। Difference between arguments and parameters</h2>
...
<h2 id="what-is-first-class-function-or-higher-order-function">১০। What is first-class function or higher-order function?</h2>
...
<h2 id="difference-between-first-order-function-and-higher-order-function">১১। Difference between first-order function and higher-order function</h2>
...
<h2 id="difference-between-first-order-logic-and-higher-order-logic">১২। Difference between first order logic and higher order logic</h2>
...
<h2 id="what-is-callback-function">১৩। What is callback function?</h2>
...
<h2 id="what-is-the-first-class-citizen">১৪। What is the first-class citizen?</h2>
...
<h2 id="what-is-init-function">১৫। What is init function?</h2>
...
<h2 id="difference-between-compile-time-and-run-time">১৬। Difference between compile time and run time</h2>
...
<h2 id="what-is-escape-analysis">১৭। What is escape analysis?</h2>
...
<h2 id="describe-2-phases-of-running-a-go-program">১৮। Describe 2 phases of running a Go program</h2>
...
<h2 id="what-is-closure-in-go">১৯। What is closure in Go?</h2>
...
<h2 id="what-is-struct-in-go">২০। What is struct in Go?</h2>
...
<h2 id="what-is-an-instance">২১। What is an instance?</h2>
...
<h2 id="what-are-member-variables">২২। What are member variables?</h2>
...
<h2 id="what-is-instantiation">২৩। What is instantiation?</h2>
...
<h2 id="what-is-the-receiver-function">২৪। What is the receiver function?</h2>
...
<h2 id="difference-between-expression-and-statement">২৫। Difference between expression and statement</h2>
...
<h2 id="what-is-pointer-and-difference-between-pass-by-value-vs-pass-by-reference">২৬। what is pointer? And difference between pass by value vs pass by reference</h2>
...
<h2 id="difference-between-pass-by-value-vs-pass-by-reference">২৭। Difference between pass by value vs pass by reference</h2>
...
<h2 id="describe-internal-memory-of-a-go-program">২৮। Describe internal memory of a Go program</h2>
...
**বিঃদ্রঃ Go প্রোগ্রাম রান হওয়ার জন্য অবশ্যই একটা মেইন ফাংশন থাকতে হবে।**

**Code Segemnt:** প্রোগ্রামে যত ফাংশন আছে সব ফাংশন চলে যায় কোড সেগমেন্টের মধ্যে অর্থাৎ ফাংশন ডেফিনিশন বা রিড অনলি ডাটাগুলি এই সেগমেন্টে স্টোর হয়।

**Data Segment:** প্রোগ্রামে যত গ্লোবাল ভেরিয়েবল আছে সব জমা হবে ডাটা সেগমেন্টের ভিতরে। ডাটা সেগমেন্ট মানেই গ্লোবাল মেমোরি, এই গ্লোবাল মেমোরিতে যেকোনো ফাংশন হচ্ছে যদি তার মধ্যে না থাকে সে, কোথায় খুঁজবে ? সে দেখবে ডাটা সেগমেন্টে আছে কিনা অর্থাৎ গ্লোবাল মেমোরিতে আছে কিনা।

**Stack:** Local Variables এবং ফাংশন কল স্ট্যাক মেমরিতে সংরক্ষিত হয় অর্থাৎ Code Segment এ থাকা ফাংশন যখন ইনবুক (invoke) হয় তখন ফাংশন কলের জন্য stack এ যে মেমরি অ্যালোকেট হয় তাকে বলা হয় StackFrame। এভাবে প্রতিটা ফাংশন এক্সিকিউশন শেষে StackFrame পপ আউট হয়ে যায়। এটি Last-In-First-Out (LIFO) পদ্ধতিতে কাজ করে।
...
**Heap:** হিপ হলো মেমরির আরেকটি অংশ যেখানে দীর্ঘস্থায়ী ডেটা সংরক্ষণ করা হয়। ডায়নামিক অবজেক্ট যেমন গো'র স্ট্রাকচার, স্লাইস, ম্যাপ,পয়েন্টার, চ্যানেল ইত্যাদি হিপ মেমোরিতে সংরক্ষিত হয়। হিপ মেমোরি অনেক বড় এবং গার্বেজ কালেক্টর (Garbage Collector) এর দ্বারা পরিচালিত হয়।
...
func createUser() *User {
    user := &User{Name: "John"}  // `user` হিপে অ্যালোকেট হয় (কারণ পয়েন্টার রিটার্ন করা হচ্ছে)
    return user
}
```
